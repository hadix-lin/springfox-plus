...
class JavaDocParameterBuilder(private val docStore: DocStore) : ParameterBuilderPlugin {
    ...
    override fun apply(parameterContext: ParameterContext) {
        ...
        val parameterDescription =
            docStore.readMethodParameterDescription(typeName, methodName, parameterName)
    ...
    private fun getDefinitionNames(parameterContext: ParameterContext): Triple<String, String, String> {
        ...
        val parameterName = resolvedMethodParameter.defaultName()
            .or(resolvedMethodParameter.parameterIndex.toString())
